        ...
        module Api
          class BasicApi
            ...
            def archive_with_http_info(object_type, object_id, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{objectId}'.sub('{' + 'objectType' + '}', object_type.to_s).sub('{' + 'objectId' + '}', object_id.to_s)
            ...
            def create_with_http_info(object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}'.sub('{' + 'objectType' + '}', object_type.to_s)
            ...
            # @option opts [Array<String>] :associations A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
            # @option opts [BOOLEAN] :archived Whether to return only results that have been archived.
            # @return [Array<(CollectionResponseSimplePublicObject, Fixnum, Hash)>] CollectionResponseSimplePublicObject data, response status code and response headers
            def get_page_with_http_info(object_type, opts = {})
              ...
              data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                ...
                :body => post_body,
                :auth_names => auth_names,
                :return_type => 'CollectionResponseSimplePublicObject')
              if @api_client.config.debugging
