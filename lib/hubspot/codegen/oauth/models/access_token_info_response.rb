  ...
  module OAuth
    class AccessTokenInfoResponse
      ...
      def initialize(attributes = {})
        ...
        if attributes.key?(:'scope_to_scope_group_pks')
          if (value = attributes[:'scope_to_scope_group_pks']).is_a?(Array)
            self.scope_to_scope_group_pks = value
          end
        end
      ...
      def list_invalid_properties
        ...
        if @scope_to_scope_group_pks.nil?
