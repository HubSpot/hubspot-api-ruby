  ...
  module Automation
    module Actions
      class PublicActionLabels
        ...
        attr_accessor :output_field_labels

        attr_accessor :input_field_option_labels
        ...
        def self.openapi_types
          {
            ...
            :'output_field_labels' => :'Hash<String, String>',
            :'input_field_option_labels' => :'Hash<String, Hash<String, String>>',
            :'action_description' => :'String',
            :'execution_rules' => :'Hash<String, String>',
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Automation::Actions::PublicActionLabels` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Automation::Actions::PublicActionLabels`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'output_field_labels')
            if (value = attributes[:'output_field_labels']).is_a?(Hash)
              self.output_field_labels = value
            end
          end

          if attributes.key?(:'input_field_option_labels')
            if (value = attributes[:'input_field_option_labels']).is_a?(Hash)
              self.input_field_option_labels = value
            end
          end
          ...
          if attributes.key?(:'execution_rules')
            if (value = attributes[:'execution_rules']).is_a?(Hash)
        ...
        def ==(o)
          ...
          self.class == o.class &&
              ...
              output_field_labels == o.output_field_labels &&
              input_field_option_labels == o.input_field_option_labels &&
        ...
        def hash
          [input_field_descriptions, app_display_name, output_field_labels, input_field_option_labels, action_description, execution_rules, input_field_labels, action_name, action_card_content].hash
        end
