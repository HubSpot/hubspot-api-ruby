      ...
      class Option
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Automation::Actions::Option` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Automation::Actions::Option`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'double_data')
            self.double_data = attributes[:'double_data']
          end
        ...
        def list_invalid_properties
          ...
          if @double_data.nil?
            invalid_properties.push('invalid value for "double_data", double_data cannot be nil.')
          end
        ...
        def valid?
          ...
          return false if @double_data.nil?
        ...
        def hash
          [label, value, display_order, double_data, hidden, description, read_only].hash
        end
