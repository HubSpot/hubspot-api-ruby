      ...
      class PublicSingleFieldDependency
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Automation::Actions::PublicSingleFieldDependency` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Automation::Actions::PublicSingleFieldDependency`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'dependency_type')
            ...
            self.dependency_type = 'SINGLE_FIELD'
          end
        ...
        def valid?
          ...
          dependency_type_validator = EnumAttributeValidator.new('String', ["SINGLE_FIELD"])
        ...
        def dependency_type=(dependency_type)
          validator = EnumAttributeValidator.new('String', ["SINGLE_FIELD"])
        ...
        def hash
          [dependency_type, dependent_field_names, controlling_field_name].hash
        end
