  ...
  module Marketing
    module Events
      class MarketingEventPublicDefaultResponse
        ...
        def hash
          [event_name, event_type, start_date_time, end_date_time, event_organizer, event_description, event_url, event_cancelled, custom_properties, id, created_at, updated_at].hash
        end
