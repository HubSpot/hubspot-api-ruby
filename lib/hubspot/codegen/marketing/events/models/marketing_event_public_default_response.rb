  ...
  module Marketing
    module Events
      class MarketingEventPublicDefaultResponse
        ...
        def hash
          [created_at, start_date_time, custom_properties, event_cancelled, event_organizer, event_url, event_description, event_name, event_type, id, end_date_time, updated_at].hash
        end
