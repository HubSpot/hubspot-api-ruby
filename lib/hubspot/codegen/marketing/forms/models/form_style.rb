  ...
  module Marketing
    module Forms
      class FormStyle
        ...
        def hash
          [font_family, background_width, label_text_color, label_text_size, help_text_color, help_text_size, legal_consent_text_color, legal_consent_text_size, submit_color, submit_alignment, submit_font_color, submit_size].hash
        end
