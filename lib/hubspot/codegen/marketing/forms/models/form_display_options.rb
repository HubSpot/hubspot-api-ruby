    ...
    module Forms
      class FormDisplayOptions
        ...
        def valid?
          ...
          theme_validator = EnumAttributeValidator.new('String', ["default_style", "canvas", "linear", "round", "sharp"])
        ...
        def theme=(theme)
          validator = EnumAttributeValidator.new('String', ["default_style", "canvas", "linear", "round", "sharp"])
        ...
        def hash
          [render_raw_html, theme, submit_button_text, style, css_class].hash
        end
