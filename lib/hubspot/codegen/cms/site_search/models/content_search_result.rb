  ...
  module Cms
    module SiteSearch
      class ContentSearchResult
        ...
        def hash
          [combined_id, description, language, type, title, url, tags, row_id, featured_image_url, score, author_full_name, domain, table_id, id, published_date, category, subcategory].hash
        end
