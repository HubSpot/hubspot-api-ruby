  ...
  module Cms
    module Domains
      class DomainsApi
        ...
        # @param [Hash] opts the optional parameters
        # @option opts [DateTime] :created_at Only return domains created at this date.
        # @option opts [DateTime] :created_after Only return domains created after this date.
        # @option opts [DateTime] :created_before Only return domains created before this date.
        # @option opts [DateTime] :updated_at Only return domains updated at this date.
        # @option opts [DateTime] :updated_after Only return domains updated after this date.
        # @option opts [DateTime] :updated_before Only return domains updated before this date.
        ...
        def get_page_with_http_info(opts = {})
          ...
          # return_type
          return_type = opts[:return_type] || 'CollectionResponseWithTotalDomainForwardPaging' 
