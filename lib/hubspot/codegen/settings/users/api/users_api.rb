    ...
    module Users
      class UsersApi
        ...
        def create_with_http_info(user_provision_request, opts = {})
          ...
          # http body (model)
          post_body = opts[:body] || @api_client.object_to_http_body(user_provision_request) 

          # return_type
          return_type = opts[:return_type] || 'PublicUser' 
        ...
        def get_page_with_http_info(opts = {})
          ...
          # return_type
          return_type = opts[:return_type] || 'CollectionResponsePublicUserForwardPaging' 
        ...
        def replace_with_http_info(user_id, public_user_update, opts = {})
          ...
          # http body (model)
          post_body = opts[:body] || @api_client.object_to_http_body(public_user_update) 
