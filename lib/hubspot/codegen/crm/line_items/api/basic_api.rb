        ...
        module Api
          class BasicApi
            ...
            def archive(line_item_id, opts = {})
              archive_with_http_info(line_item_id, opts)
              nil
            end
            ...
            def archive_with_http_info(line_item_id, opts = {})
              ...
              # resource path
              local_var_path = '/line items/{lineItemId}'.sub('{' + 'lineItemId' + '}', CGI.escape(line_item_id.to_s))
            ...
            # @option opts [SimplePublicObjectInput] :simple_public_object_input 
            # @return [SimplePublicObject]
            def update(line_item_id, opts = {})
              data, _status_code, _headers = update_with_http_info(line_item_id, opts)
              data
            end
            ...
            # @option opts [SimplePublicObjectInput] :simple_public_object_input 
            # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
            def update_with_http_info(line_item_id, opts = {})
              if @api_client.config.debugging
