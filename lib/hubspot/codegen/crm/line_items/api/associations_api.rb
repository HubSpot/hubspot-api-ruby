  ...
  module Crm
    module LineItems
      class AssociationsApi
        ...
        # @return [nil]
        def archive_association(line_item_id, to_object_type, to_object_id, association_type, opts = {})
          archive_association_with_http_info(line_item_id, to_object_type, to_object_id, association_type, opts)
          nil
        end
        ...
        def archive_association_with_http_info(line_item_id, to_object_type, to_object_id, association_type, opts = {})
        ...
        def create_association(line_item_id, to_object_type, to_object_id, association_type, opts = {})
          data, _status_code, _headers = create_association_with_http_info(line_item_id, to_object_type, to_object_id, association_type, opts)
          data
        end
        ...
        def create_association_with_http_info(line_item_id, to_object_type, to_object_id, association_type, opts = {})
          if @api_client.config.debugging
        ...
        def get_associations(line_item_id, to_object_type, opts = {})
          data, _status_code, _headers = get_associations_with_http_info(line_item_id, to_object_type, opts)
          data
        end
        ...
        def get_associations_with_http_info(line_item_id, to_object_type, opts = {})
          if @api_client.config.debugging
