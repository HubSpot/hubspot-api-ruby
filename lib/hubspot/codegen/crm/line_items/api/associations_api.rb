  ...
  module Crm
    module LineItems
      class AssociationsApi
        ...
        # @return [nil]
        def archive_association(line_item_id, associated_object_type, to_object_id, opts = {})
          archive_association_with_http_info(line_item_id, associated_object_type, to_object_id, opts)
          nil
        end
        ...
        def archive_association_with_http_info(line_item_id, associated_object_type, to_object_id, opts = {})
          ...
          if @api_client.config.client_side_validation && line_item_id.nil?
            fail ArgumentError, "Missing the required parameter 'line_item_id' when calling AssociationsApi.archive_association"
          end
          ...
          # resource path
          local_var_path = '/crm/v3/objects/line_items/{lineItemId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'lineItemId' + '}', CGI.escape(line_item_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/')).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s).gsub('%2F', '/'))
        ...
        def create_association(line_item_id, associated_object_type, to_object_id, opts = {})
          data, _status_code, _headers = create_association_with_http_info(line_item_id, associated_object_type, to_object_id, opts)
          data
        end
        ...
        def create_association_with_http_info(line_item_id, associated_object_type, to_object_id, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.create_association ...'
          end
          # verify the required parameter 'line_item_id' is set
          if @api_client.config.client_side_validation && line_item_id.nil?
            fail ArgumentError, "Missing the required parameter 'line_item_id' when calling AssociationsApi.create_association"
          end
          # verify the required parameter 'associated_object_type' is set
          if @api_client.config.client_side_validation && associated_object_type.nil?
        ...
        def get_associations(line_item_id, associated_object_type, opts = {})
          data, _status_code, _headers = get_associations_with_http_info(line_item_id, associated_object_type, opts)
          data
        end
        ...
        def get_associations_with_http_info(line_item_id, associated_object_type, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.get_associations ...'
          end
          # verify the required parameter 'line_item_id' is set
          if @api_client.config.client_side_validation && line_item_id.nil?
            fail ArgumentError, "Missing the required parameter 'line_item_id' when calling AssociationsApi.get_associations"
          end
          # verify the required parameter 'associated_object_type' is set
          if @api_client.config.client_side_validation && associated_object_type.nil?
          ...
          # resource path
          local_var_path = '/crm/v3/objects/line_items/{lineItemId}/associations/{associatedObjectType}'.sub('{' + 'lineItemId' + '}', CGI.escape(line_item_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/'))
