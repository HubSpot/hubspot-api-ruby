    ...
    module Companies
      class AssociationsApi
        ...
        def get_all_with_http_info(company_id, to_object_type, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v4/objects/companies/{companyId}/associations/{toObjectType}'.sub('{' + 'companyId' + '}', CGI.escape(company_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
