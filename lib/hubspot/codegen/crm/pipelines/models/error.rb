        ...
        module Models
          class Error
            ...
            def list_invalid_properties
              ...
              if @correlation_id !~ Regexp.new(/[a-zA-Z0-9]{32}/)
                invalid_properties.push('invalid value for "correlation_id", must conform to the pattern /[a-zA-Z0-9]{32}/.')
              end
            ...
            def correlation_id=(correlation_id)
              ...
              if correlation_id !~ Regexp.new(/[a-zA-Z0-9]{32}/)
                fail ArgumentError, 'invalid value for "correlation_id", must conform to the pattern /[a-zA-Z0-9]{32}/.'
              end
            ...
            def _deserialize(type, value)
              ...
              when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
                ...
                temp_model = Hubspot::Client::Crm::Pipelines::Models.const_get(type).new
