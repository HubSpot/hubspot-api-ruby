        ...
        module Api
          class PipelinesApi
            ...
            def archive_with_http_info(object_type, pipeline_id, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{pipelineId}'.sub('{' + 'objectType' + '}', object_type.to_s).sub('{' + 'pipelineId' + '}', pipeline_id.to_s)
            ...
            # @param [Hash] opts the optional parameters
            # @option opts [BOOLEAN] :archived Whether to return only results that have been archived.
            # @return [Array<(CollectionResponsePipeline, Fixnum, Hash)>] CollectionResponsePipeline data, response status code and response headers
            def get_page_with_http_info(object_type, opts = {})
              ...
              data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                ...
                :body => post_body,
                :auth_names => auth_names,
                :return_type => 'CollectionResponsePipeline')
              if @api_client.config.debugging
