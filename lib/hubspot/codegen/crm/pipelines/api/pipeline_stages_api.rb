        ...
        module Api
          class PipelineStagesApi
            ...
            def archive_with_http_info(object_type, pipeline_id, stage_id, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{pipelineId}/stages/{stageId}'.sub('{' + 'objectType' + '}', object_type.to_s).sub('{' + 'pipelineId' + '}', pipeline_id.to_s).sub('{' + 'stageId' + '}', stage_id.to_s)
            ...
            # @param [Hash] opts the optional parameters
            # @option opts [PipelineStageInput] :body 
            # @return [Array<(PipelineStage, Fixnum, Hash)>] PipelineStage data, response status code and response headers
            def create_with_http_info(object_type, pipeline_id, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{pipelineId}/stages'.sub('{' + 'objectType' + '}', object_type.to_s).sub('{' + 'pipelineId' + '}', pipeline_id.to_s)
            ...
            # @param [Hash] opts the optional parameters
            # @option opts [BOOLEAN] :archived Whether to return only results that have been archived.
            # @return [Array<(CollectionResponsePipelineStage, Fixnum, Hash)>] CollectionResponsePipelineStage data, response status code and response headers
            def get_page_with_http_info(object_type, pipeline_id, opts = {})
              ...
              data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                ...
                :body => post_body,
                :auth_names => auth_names,
                :return_type => 'CollectionResponsePipelineStage')
              if @api_client.config.debugging
