      ...
      class PropertyValue
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Imports::PropertyValue` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Imports::PropertyValue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
        ...
        def list_invalid_properties
          ...
          if @persistence_timestamp.nil?
            invalid_properties.push('invalid value for "persistence_timestamp", persistence_timestamp cannot be nil.')
          end
          ...
          if @use_timestamp_as_persistence_timestamp.nil?
            invalid_properties.push('invalid value for "use_timestamp_as_persistence_timestamp", use_timestamp_as_persistence_timestamp cannot be nil.')
          end
          ...
          if @is_large_value.nil?
            invalid_properties.push('invalid value for "is_large_value", is_large_value cannot be nil.')
          end
        ...
        def valid?
          ...
          return false if @persistence_timestamp.nil?
          ...
          return false if @use_timestamp_as_persistence_timestamp.nil?
          return false if @value.nil?
          return false if @selected_by_user_timestamp.nil?
          return false if @timestamp.nil?
          return false if @is_large_value.nil?
          true
        end
