  ...
  module Crm
    module Imports
      class CoreApi
        ...
        # @param [Hash] opts the optional parameters
        # @option opts [String] :import_request JSON formatted metadata about the import. This includes a name for the import and the column mappings for each file. See [this page]() for more on the required format.
