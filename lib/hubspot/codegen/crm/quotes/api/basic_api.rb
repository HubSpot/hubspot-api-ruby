  ...
  module Crm
    module Quotes
      class BasicApi
        ...
        # @return [nil]
        def delete_crm_v3_objects_quotes_quote_id(quote_id, opts = {})
          delete_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, opts)
          nil
        end
        ...
        def delete_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.delete_crm_v3_objects_quotes_quote_id ...'
          end
          # verify the required parameter 'quote_id' is set
          if @api_client.config.client_side_validation && quote_id.nil?
            fail ArgumentError, "Missing the required parameter 'quote_id' when calling BasicApi.delete_crm_v3_objects_quotes_quote_id"
          end
          # resource path
          ...
          new_options = opts.merge(
            :operation => :"BasicApi.delete_crm_v3_objects_quotes_quote_id",
          ...
          if @api_client.config.debugging
            @api_client.config.logger.debug "API called: BasicApi#delete_crm_v3_objects_quotes_quote_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
          end
        ...
        def get_crm_v3_objects_quotes(opts = {})
          data, _status_code, _headers = get_crm_v3_objects_quotes_with_http_info(opts)
          data
        end
        ...
        def get_crm_v3_objects_quotes_with_http_info(opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.get_crm_v3_objects_quotes ...'
          end
          # resource path
          ...
          new_options = opts.merge(
            :operation => :"BasicApi.get_crm_v3_objects_quotes",
            :header_params => header_params,
            :query_params => query_params,
            :form_params => form_params,
            :body => post_body,
          ...
          if @api_client.config.debugging
            @api_client.config.logger.debug "API called: BasicApi#get_crm_v3_objects_quotes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
          end
          return data, status_code, headers
        end
        ...
        def get_crm_v3_objects_quotes_quote_id(quote_id, opts = {})
          data, _status_code, _headers = get_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, opts)
          data
        end
        ...
        def get_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.get_crm_v3_objects_quotes_quote_id ...'
          end
          # verify the required parameter 'quote_id' is set
          if @api_client.config.client_side_validation && quote_id.nil?
            fail ArgumentError, "Missing the required parameter 'quote_id' when calling BasicApi.get_crm_v3_objects_quotes_quote_id"
          end
          # resource path
          local_var_path = '/crm/v3/objects/quotes/{quoteId}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s))
          ...
          new_options = opts.merge(
            :operation => :"BasicApi.get_crm_v3_objects_quotes_quote_id",
            :header_params => header_params,
            :query_params => query_params,
            :form_params => form_params,
            :body => post_body,
          ...
          data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
          if @api_client.config.debugging
            @api_client.config.logger.debug "API called: BasicApi#get_crm_v3_objects_quotes_quote_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
          end
          return data, status_code, headers
        end
        ...
        def patch_crm_v3_objects_quotes_quote_id(quote_id, simple_public_object_input, opts = {})
          data, _status_code, _headers = patch_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, simple_public_object_input, opts)
          data
        end
        ...
        def patch_crm_v3_objects_quotes_quote_id_with_http_info(quote_id, simple_public_object_input, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.patch_crm_v3_objects_quotes_quote_id ...'
          end
          # verify the required parameter 'quote_id' is set
          if @api_client.config.client_side_validation && quote_id.nil?
            fail ArgumentError, "Missing the required parameter 'quote_id' when calling BasicApi.patch_crm_v3_objects_quotes_quote_id"
          end
          ...
          if @api_client.config.client_side_validation && simple_public_object_input.nil?
            fail ArgumentError, "Missing the required parameter 'simple_public_object_input' when calling BasicApi.patch_crm_v3_objects_quotes_quote_id"
          end
          # resource path
          local_var_path = '/crm/v3/objects/quotes/{quoteId}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s))
          ...
          new_options = opts.merge(
            :operation => :"BasicApi.patch_crm_v3_objects_quotes_quote_id",
            :header_params => header_params,
            :query_params => query_params,
            :form_params => form_params,
            :body => post_body,
          ...
          if @api_client.config.debugging
            @api_client.config.logger.debug "API called: BasicApi#patch_crm_v3_objects_quotes_quote_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
          end
          return data, status_code, headers
        end
        ...
        # @param [Hash] opts the optional parameters
        # @return [SimplePublicObject]
        def post_crm_v3_objects_quotes(simple_public_object_input_for_create, opts = {})
          data, _status_code, _headers = post_crm_v3_objects_quotes_with_http_info(simple_public_object_input_for_create, opts)
          data
        end
        ...
        # @param [Hash] opts the optional parameters
        # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
        def post_crm_v3_objects_quotes_with_http_info(simple_public_object_input_for_create, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.post_crm_v3_objects_quotes ...'
          end
          ...
          if @api_client.config.client_side_validation && simple_public_object_input_for_create.nil?
            fail ArgumentError, "Missing the required parameter 'simple_public_object_input_for_create' when calling BasicApi.post_crm_v3_objects_quotes"
          end
          # resource path
          local_var_path = '/crm/v3/objects/quotes'
          ...
          new_options = opts.merge(
            :operation => :"BasicApi.post_crm_v3_objects_quotes",
            :header_params => header_params,
            :query_params => query_params,
            :form_params => form_params,
            :body => post_body,
          ...
          if @api_client.config.debugging
            @api_client.config.logger.debug "API called: BasicApi#post_crm_v3_objects_quotes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
          end
          return data, status_code, headers
        end
      end
