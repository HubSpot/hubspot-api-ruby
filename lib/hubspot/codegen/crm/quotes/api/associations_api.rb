  ...
  module Crm
    module Quotes
      class AssociationsApi
        ...
        # @return [nil]
        def archive(quote_id, to_object_type, to_object_id, opts = {})
          archive_with_http_info(quote_id, to_object_type, to_object_id, opts)
          nil
        end
        ...
        def archive_with_http_info(quote_id, to_object_type, to_object_id, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v4/objects/quotes/{quoteId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
        ...
        def create(quote_id, to_object_type, to_object_id, association_spec, opts = {})
          data, _status_code, _headers = create_with_http_info(quote_id, to_object_type, to_object_id, association_spec, opts)
          data
        end
        ...
        def create_with_http_info(quote_id, to_object_type, to_object_id, association_spec, opts = {})
          if @api_client.config.debugging
        ...
        def get_all_with_http_info(quote_id, to_object_type, opts = {})
          ...
          # verify the required parameter 'quote_id' is set
          if @api_client.config.client_side_validation && quote_id.nil?
            fail ArgumentError, "Missing the required parameter 'quote_id' when calling AssociationsApi.get_all"
          end
          # verify the required parameter 'to_object_type' is set
          if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          # resource path
          local_var_path = '/crm/v4/objects/quotes/{quoteId}/associations/{toObjectType}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
