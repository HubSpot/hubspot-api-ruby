      ...
      module Quotes
        module Api
          class AssociationsApi
            ...
            # @return [nil]
            def archive_association(quote_id, associated_object_type, to_object_id, opts = {})
              archive_association_with_http_info(quote_id, associated_object_type, to_object_id, opts)
              nil
            end
            ...
            def archive_association_with_http_info(quote_id, associated_object_type, to_object_id, opts = {})
              ...
              # resource path
              local_var_path = '/quotes/{quoteId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
            ...
            def create_association(quote_id, associated_object_type, to_object_id, opts = {})
              data, _status_code, _headers = create_association_with_http_info(quote_id, associated_object_type, to_object_id, opts)
              data
            end
            ...
            def create_association_with_http_info(quote_id, associated_object_type, to_object_id, opts = {})
              if @api_client.config.debugging
            ...
            def get_associations(quote_id, associated_object_type, opts = {})
              data, _status_code, _headers = get_associations_with_http_info(quote_id, associated_object_type, opts)
              data
            end
            ...
            def get_associations_with_http_info(quote_id, associated_object_type, opts = {})
              if @api_client.config.debugging
              ...
              # resource path
              local_var_path = '/quotes/{quoteId}/associations/{associatedObjectType}'.sub('{' + 'quoteId' + '}', CGI.escape(quote_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s))
