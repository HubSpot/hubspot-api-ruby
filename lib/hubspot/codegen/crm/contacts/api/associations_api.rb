  ...
  module Crm
    module Contacts
      class AssociationsApi
        ...
        # @return [nil]
        def archive(contact_id, to_object_type, to_object_id, opts = {})
          archive_with_http_info(contact_id, to_object_type, to_object_id, opts)
          nil
        end
        ...
        def archive_with_http_info(contact_id, to_object_type, to_object_id, opts = {})
        ...
        def create(contact_id, to_object_type, to_object_id, association_spec, opts = {})
          data, _status_code, _headers = create_with_http_info(contact_id, to_object_type, to_object_id, association_spec, opts)
          data
        end
        ...
        def create_with_http_info(contact_id, to_object_type, to_object_id, association_spec, opts = {})
          if @api_client.config.debugging
