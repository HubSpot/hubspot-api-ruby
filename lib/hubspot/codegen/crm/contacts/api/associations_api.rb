  ...
  module Crm
    module Contacts
      class AssociationsApi
        ...
        def create(contact_id, to_object_type, to_object_id, association_type, opts = {})
          data, _status_code, _headers = create_with_http_info(contact_id, to_object_type, to_object_id, association_type, opts)
          data
        end
        ...
        def create_with_http_info(contact_id, to_object_type, to_object_id, association_type, opts = {})
          if @api_client.config.debugging
