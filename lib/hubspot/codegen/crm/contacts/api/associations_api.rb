  ...
  module Crm
    module Contacts
      class AssociationsApi
        ...
        # @return [nil]
        def archive(contact_id, to_object_type, to_object_id, association_type, opts = {})
          archive_with_http_info(contact_id, to_object_type, to_object_id, association_type, opts)
          nil
        end
        ...
        def archive_with_http_info(contact_id, to_object_type, to_object_id, association_type, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.archive ...'
          end
          # verify the required parameter 'contact_id' is set
          if @api_client.config.client_side_validation && contact_id.nil?
            fail ArgumentError, "Missing the required parameter 'contact_id' when calling AssociationsApi.archive"
          end
          ...
          # resource path
          local_var_path = '/crm/v4/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'contactId' + '}', CGI.escape(contact_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
        ...
        def create(contact_id, to_object_type, to_object_id, association_types, opts = {})
          data, _status_code, _headers = create_with_http_info(contact_id, to_object_type, to_object_id, association_types, opts)
          data
        end
        ...
        def create_with_http_info(contact_id, to_object_type, to_object_id, association_types, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.create ...'
          end
          # verify the required parameter 'contact_id' is set
          if @api_client.config.client_side_validation && contact_id.nil?
            fail ArgumentError, "Missing the required parameter 'contact_id' when calling AssociationsApi.create"
          end
          # verify the required parameter 'to_object_type' is set
          if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          # resource path
          local_var_path = '/crm/v4/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'contactId' + '}', CGI.escape(contact_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
        ...
        def get_all(contact_id, to_object_type, opts = {})
          data, _status_code, _headers = get_all_with_http_info(contact_id, to_object_type, opts)
          data
        end
        ...
        def get_all_with_http_info(contact_id, to_object_type, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.get_all ...'
          end
          # verify the required parameter 'contact_id' is set
          if @api_client.config.client_side_validation && contact_id.nil?
            fail ArgumentError, "Missing the required parameter 'contact_id' when calling AssociationsApi.get_all"
          end
          # verify the required parameter 'to_object_type' is set
          if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          # resource path
          local_var_path = '/crm/v4/objects/contacts/{contactId}/associations/{toObjectType}'.sub('{' + 'contactId' + '}', CGI.escape(contact_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
