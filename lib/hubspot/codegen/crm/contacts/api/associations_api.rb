        ...
        module Api
          class AssociationsApi
            ...
            def archive_association_with_http_info(contact_id, associated_object_type, to_object_id, opts = {})
              ...
              # resource path
              local_var_path = '/contacts/{contactId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'contactId' + '}', CGI.escape(contact_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
            ...
            def get_associations_with_http_info(contact_id, associated_object_type, opts = {})
              ...
              # resource path
              local_var_path = '/contacts/{contactId}/associations/{associatedObjectType}'.sub('{' + 'contactId' + '}', CGI.escape(contact_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s))
