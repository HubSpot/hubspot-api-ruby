        ...
        class ActionHookActionBody
          ...
          def initialize(attributes = {})
            if (!attributes.is_a?(Hash))
              fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Extensions::Cards::ActionHookActionBody` initialize method"
            end

            # check to see if the attribute exists and convert string to symbol for hash key
            attributes = attributes.each_with_object({}) { |(k, v), h|
              if (!self.class.attribute_map.key?(k.to_sym))
                fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Extensions::Cards::ActionHookActionBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
              end
              h[k.to_sym] = v
            }
          ...
          def valid?
            ...
            type_validator = EnumAttributeValidator.new('String', ["ACTION_HOOK"])
            return false unless type_validator.valid?(@type)
            return false if @http_method.nil?
            http_method_validator = EnumAttributeValidator.new('String', ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"])
          ...
          def type=(type)
            validator = EnumAttributeValidator.new('String', ["ACTION_HOOK"])
          ...
          def http_method=(http_method)
            validator = EnumAttributeValidator.new('String', ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"])
          ...
          def hash
            [type, confirmation, http_method, url, label, property_names_included].hash
          end
