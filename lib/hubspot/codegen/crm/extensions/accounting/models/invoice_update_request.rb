    ...
    module Extensions
      module Accounting
        class InvoiceUpdateRequest
          ...
          attr_accessor :received_by_customer_date
          ...
          def initialize(attributes = {})
            if (!attributes.is_a?(Hash))
              fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Extensions::Accounting::InvoiceUpdateRequest` initialize method"
            end

            # check to see if the attribute exists and convert string to symbol for hash key
            attributes = attributes.each_with_object({}) { |(k, v), h|
              if (!self.class.attribute_map.key?(k.to_sym))
                fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Extensions::Accounting::InvoiceUpdateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
              end
              h[k.to_sym] = v
            }
            ...
            if attributes.key?(:'received_by_customer_date')
              self.received_by_customer_date = attributes[:'received_by_customer_date']
            end
          ...
          def ==(o)
            ...
            self.class == o.class &&
                ...
                received_by_customer_date == o.received_by_customer_date &&
          ...
          def hash
            [external_invoice_number, currency_code, due_date, external_recipient_id, received_by_recipient_date, is_voided, received_by_customer_date, invoice_number].hash
          end
