        ...
        class Product
          ...
          def initialize(attributes = {})
            if (!attributes.is_a?(Hash))
              fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Extensions::Accounting::Product` initialize method"
            end

            # check to see if the attribute exists and convert string to symbol for hash key
            attributes = attributes.each_with_object({}) { |(k, v), h|
              if (!self.class.attribute_map.key?(k.to_sym))
                fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Extensions::Accounting::Product`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
              end
              h[k.to_sym] = v
            }
            ...
            if attributes.key?(:'sales_tax_type')
              self.sales_tax_type = attributes[:'sales_tax_type']
            end
          ...
          def ==(o)
            ...
            self.class == o.class &&
                ...
                sales_tax_type == o.sales_tax_type &&
                name == o.name &&
          ...
          def hash
            [unit_price, tax_exempt, sales_tax_type, name, description, id].hash
          end
