    ...
    module Extensions
      module Accounting
        class ExchangeRateResponse
          ...
          attr_accessor :target_currency_code
          ...
          def initialize(attributes = {})
            if (!attributes.is_a?(Hash))
              fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Extensions::Accounting::ExchangeRateResponse` initialize method"
            end

            # check to see if the attribute exists and convert string to symbol for hash key
            attributes = attributes.each_with_object({}) { |(k, v), h|
              if (!self.class.attribute_map.key?(k.to_sym))
                fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Extensions::Accounting::ExchangeRateResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
              end
              h[k.to_sym] = v
            }
            ...
            if attributes.key?(:'target_currency_code')
              self.target_currency_code = attributes[:'target_currency_code']
            end
          end
          ...
          def list_invalid_properties
            ...
            if @target_currency_code.nil?
              invalid_properties.push('invalid value for "target_currency_code", target_currency_code cannot be nil.')
            end
          ...
          def valid?
            ...
            result_validator = EnumAttributeValidator.new('String', ["OK", "ERR"])
            ...
            return false if @target_currency_code.nil?
            true
          end
          ...
          def result=(result)
            validator = EnumAttributeValidator.new('String', ["OK", "ERR"])
          ...
          def ==(o)
            ...
            self.class == o.class &&
                ...
                target_currency_code == o.target_currency_code
          end
          ...
          def hash
            [result, exchange_rate, source_currency_code, target_currency_code].hash
          end
