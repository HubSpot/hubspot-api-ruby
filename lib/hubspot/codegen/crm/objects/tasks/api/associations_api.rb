      ...
      module Tasks
        class AssociationsApi
          ...
          def archive_with_http_info(task_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v4/objects/tasks/{taskId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'taskId' + '}', CGI.escape(task_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
