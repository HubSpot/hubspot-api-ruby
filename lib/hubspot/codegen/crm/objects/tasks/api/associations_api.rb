    ...
    module Objects
      module Tasks
        class AssociationsApi
          ...
          # @return [nil]
          def archive(task_id, to_object_type, to_object_id, opts = {})
            archive_with_http_info(task_id, to_object_type, to_object_id, opts)
            nil
          end
          ...
          def archive_with_http_info(task_id, to_object_type, to_object_id, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v4/objects/tasks/{taskId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'taskId' + '}', CGI.escape(task_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
          ...
          def create(task_id, to_object_type, to_object_id, association_spec, opts = {})
            data, _status_code, _headers = create_with_http_info(task_id, to_object_type, to_object_id, association_spec, opts)
            data
          end
          ...
          def create_with_http_info(task_id, to_object_type, to_object_id, association_spec, opts = {})
            if @api_client.config.debugging
          ...
          def get_all_with_http_info(task_id, to_object_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v4/objects/tasks/{taskId}/associations/{toObjectType}'.sub('{' + 'taskId' + '}', CGI.escape(task_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
