    ...
    module Objects
      module Goals
        class BasicApi
          ...
          # @return [nil]
          def archive(goal_target_id, opts = {})
            archive_with_http_info(goal_target_id, opts)
            nil
          end
          ...
          def archive_with_http_info(goal_target_id, opts = {})
            ...
            if @api_client.config.client_side_validation && goal_target_id.nil?
              fail ArgumentError, "Missing the required parameter 'goal_target_id' when calling BasicApi.archive"
            end
            # resource path
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object type
          # @return [SimplePublicObject]
          def update(goal_target_id, simple_public_object_input, opts = {})
            data, _status_code, _headers = update_with_http_info(goal_target_id, simple_public_object_input, opts)
            data
          end
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object type
          # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
          def update_with_http_info(goal_target_id, simple_public_object_input, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.update ...'
            end
            # verify the required parameter 'goal_target_id' is set
            if @api_client.config.client_side_validation && goal_target_id.nil?
              fail ArgumentError, "Missing the required parameter 'goal_target_id' when calling BasicApi.update"
            end
