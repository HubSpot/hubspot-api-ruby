    ...
    module Objects
      module Emails
        class AssociationsApi
          ...
          # @return [nil]
          def archive(email_id, to_object_type, to_object_id, association_type, opts = {})
            archive_with_http_info(email_id, to_object_type, to_object_id, association_type, opts)
            nil
          end
          ...
          def archive_with_http_info(email_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v3/objects/emails/{emailId}/associations/{toObjectType}/{toObjectId}/{associationType}'.sub('{' + 'emailId' + '}', CGI.escape(email_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
          ...
          def create(email_id, to_object_type, to_object_id, association_type, opts = {})
            data, _status_code, _headers = create_with_http_info(email_id, to_object_type, to_object_id, association_type, opts)
            data
          end
          ...
          def create_with_http_info(email_id, to_object_type, to_object_id, association_type, opts = {})
            if @api_client.config.debugging
          ...
          def get_all_with_http_info(email_id, to_object_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v3/objects/emails/{emailId}/associations/{toObjectType}'.sub('{' + 'emailId' + '}', CGI.escape(email_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
