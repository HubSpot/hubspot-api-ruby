      ...
      module Communications
        class BasicApi
          ...
          def archive(communication_id, opts = {})
            archive_with_http_info(communication_id, opts)
            nil
          end
          ...
          def get_by_id(communication_id, opts = {})
            data, _status_code, _headers = get_by_id_with_http_info(communication_id, opts)
            data
          end
          ...
          def get_by_id_with_http_info(communication_id, opts = {})
            if @api_client.config.debugging
          ...
          # @param communication_id [String] The ID of the communication to update.
          # @param simple_public_object_input [SimplePublicObjectInput] 
          # @param [Hash] opts the optional parameters
          # @option opts [String] :id_property The name of a property whose values are unique for this object
          # @return [SimplePublicObject]
          def update(communication_id, simple_public_object_input, opts = {})
            data, _status_code, _headers = update_with_http_info(communication_id, simple_public_object_input, opts)
            data
          end
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object
          # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
          def update_with_http_info(communication_id, simple_public_object_input, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.update ...'
            end
            # verify the required parameter 'communication_id' is set
            if @api_client.config.client_side_validation && communication_id.nil?
              fail ArgumentError, "Missing the required parameter 'communication_id' when calling BasicApi.update"
            end
