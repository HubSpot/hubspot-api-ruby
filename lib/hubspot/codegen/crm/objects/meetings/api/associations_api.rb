    ...
    module Objects
      module Meetings
        class AssociationsApi
          ...
          # @return [nil]
          def archive(meeting_id, to_object_type, to_object_id, association_type, opts = {})
            archive_with_http_info(meeting_id, to_object_type, to_object_id, association_type, opts)
            nil
          end
          ...
          def archive_with_http_info(meeting_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling AssociationsApi.archive"
            end
            ...
            # resource path
            local_var_path = '/crm/v3/objects/meetings/{meetingId}/associations/{toObjectType}/{toObjectId}/{associationType}'.sub('{' + 'meetingId' + '}', CGI.escape(meeting_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
          ...
          def create(meeting_id, to_object_type, to_object_id, association_type, opts = {})
            data, _status_code, _headers = create_with_http_info(meeting_id, to_object_type, to_object_id, association_type, opts)
            data
          end
          ...
          def create_with_http_info(meeting_id, to_object_type, to_object_id, association_type, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: AssociationsApi.create ...'
            end
            # verify the required parameter 'meeting_id' is set
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling AssociationsApi.create"
            end
            # verify the required parameter 'to_object_type' is set
            if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          def get_all(meeting_id, to_object_type, opts = {})
            data, _status_code, _headers = get_all_with_http_info(meeting_id, to_object_type, opts)
            data
          end
          ...
          def get_all_with_http_info(meeting_id, to_object_type, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: AssociationsApi.get_all ...'
            end
            # verify the required parameter 'meeting_id' is set
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling AssociationsApi.get_all"
            end
            # verify the required parameter 'to_object_type' is set
            if @api_client.config.client_side_validation && to_object_type.nil?
            ...
            # resource path
            local_var_path = '/crm/v3/objects/meetings/{meetingId}/associations/{toObjectType}'.sub('{' + 'meetingId' + '}', CGI.escape(meeting_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
