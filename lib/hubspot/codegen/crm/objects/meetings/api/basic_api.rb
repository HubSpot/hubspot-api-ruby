      ...
      module Meetings
        class BasicApi
          ...
          def archive(meeting_id, opts = {})
            archive_with_http_info(meeting_id, opts)
            nil
          end
          ...
          def archive_with_http_info(meeting_id, opts = {})
            ...
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling BasicApi.archive"
            end
            # resource path
            local_var_path = '/crm/v3/objects/meetings/{meetingId}'.sub('{' + 'meetingId' + '}', CGI.escape(meeting_id.to_s))
          ...
          def get_by_id(meeting_id, opts = {})
            data, _status_code, _headers = get_by_id_with_http_info(meeting_id, opts)
            data
          end
          ...
          def get_by_id_with_http_info(meeting_id, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.get_by_id ...'
            end
            # verify the required parameter 'meeting_id' is set
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling BasicApi.get_by_id"
            end
            # resource path
            local_var_path = '/crm/v3/objects/meetings/{meetingId}'.sub('{' + 'meetingId' + '}', CGI.escape(meeting_id.to_s))
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object type
          # @return [SimplePublicObject]
          def update(meeting_id, simple_public_object_input, opts = {})
            data, _status_code, _headers = update_with_http_info(meeting_id, simple_public_object_input, opts)
            data
          end
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object type
          # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
          def update_with_http_info(meeting_id, simple_public_object_input, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.update ...'
            end
            # verify the required parameter 'meeting_id' is set
            if @api_client.config.client_side_validation && meeting_id.nil?
              fail ArgumentError, "Missing the required parameter 'meeting_id' when calling BasicApi.update"
            end
            # verify the required parameter 'simple_public_object_input' is set
            if @api_client.config.client_side_validation && simple_public_object_input.nil?
