  ...
  module Crm
    module Objects
      class SearchApi
        ...
        # @option opts [PublicObjectSearchRequest] :body 
        # @return [CollectionResponseWithTotalSimplePublicObject]
        def do_search(object_type, opts = {})
          data, _status_code, _headers = do_search_with_http_info(object_type, opts)
          data
        end
        ...
        def do_search_with_http_info(object_type, opts = {})
