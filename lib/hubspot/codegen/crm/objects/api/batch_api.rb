        ...
        module Api
          class BatchApi
            ...
            def archive_batch_with_http_info(object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/batch/archive'.sub('{' + 'objectType' + '}', object_type.to_s)
            ...
            # @param [Hash] opts the optional parameters
            # @option opts [BatchInputSimplePublicObjectInput] :body 
            # @return [Array<(BatchResponseSimplePublicObject, Fixnum, Hash)>] BatchResponseSimplePublicObject data, response status code and response headers
            def create_batch_with_http_info(object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/batch/create'.sub('{' + 'objectType' + '}', object_type.to_s)
              ...
              data, status_code, headers = @api_client.call_api(:POST, local_var_path,
                ...
                :body => post_body,
                :auth_names => auth_names,
                :return_type => 'BatchResponseSimplePublicObject')
              if @api_client.config.debugging
            ...
            def read_batch_with_http_info(object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/batch/read'.sub('{' + 'objectType' + '}', object_type.to_s)
            ...
            def update_batch_with_http_info(object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/batch/update'.sub('{' + 'objectType' + '}', object_type.to_s)
