        ...
        module Api
          class AssociationsApi
            ...
            def archive_association_with_http_info(object_type, object_id, associated_object_type, to_object_id, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{objectId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'objectType' + '}', CGI.escape(object_type.to_s)).sub('{' + 'objectId' + '}', CGI.escape(object_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
            ...
            def get_associations_with_http_info(object_type, object_id, associated_object_type, opts = {})
              ...
              # resource path
              local_var_path = '/{objectType}/{objectId}/associations/{associatedObjectType}'.sub('{' + 'objectType' + '}', CGI.escape(object_type.to_s)).sub('{' + 'objectId' + '}', CGI.escape(object_id.to_s)).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s))
