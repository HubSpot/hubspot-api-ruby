      ...
      module Calls
        class AssociationsApi
          ...
          def archive_with_http_info(call_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v3/objects/calls/{callId}/associations/{toObjectType}/{toObjectId}/{associationType}'.sub('{' + 'callId' + '}', CGI.escape(call_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
          ...
          def get_all_with_http_info(call_id, to_object_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v3/objects/calls/{callId}/associations/{toObjectType}'.sub('{' + 'callId' + '}', CGI.escape(call_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
