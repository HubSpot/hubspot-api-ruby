    ...
    module Objects
      module Calls
        class AssociationsApi
          ...
          # @return [nil]
          def archive(call_id, to_object_type, to_object_id, opts = {})
            archive_with_http_info(call_id, to_object_type, to_object_id, opts)
            nil
          end
          ...
          def archive_with_http_info(call_id, to_object_type, to_object_id, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v4/objects/calls/{callId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'callId' + '}', CGI.escape(call_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s))
          ...
          def create(call_id, to_object_type, to_object_id, association_spec, opts = {})
            data, _status_code, _headers = create_with_http_info(call_id, to_object_type, to_object_id, association_spec, opts)
            data
          end
          ...
          def create_with_http_info(call_id, to_object_type, to_object_id, association_spec, opts = {})
            if @api_client.config.debugging
