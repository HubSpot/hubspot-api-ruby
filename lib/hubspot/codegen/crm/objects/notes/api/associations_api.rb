        ...
        class AssociationsApi
          ...
          def archive_with_http_info(note_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            if @api_client.config.client_side_validation && note_id.nil?
              fail ArgumentError, "Missing the required parameter 'note_id' when calling AssociationsApi.archive"
            end
            ...
            # resource path
            local_var_path = '/crm/v3/objects/notes/{noteId}/associations/{toObjectType}/{toObjectId}/{associationType}'.sub('{' + 'noteId' + '}', CGI.escape(note_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
          ...
          def create_with_http_info(note_id, to_object_type, to_object_id, association_type, opts = {})
            ...
            # verify the required parameter 'note_id' is set
            if @api_client.config.client_side_validation && note_id.nil?
              fail ArgumentError, "Missing the required parameter 'note_id' when calling AssociationsApi.create"
            end
            # verify the required parameter 'to_object_type' is set
            if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          def get_all_with_http_info(note_id, to_object_type, opts = {})
            ...
            # verify the required parameter 'note_id' is set
            if @api_client.config.client_side_validation && note_id.nil?
              fail ArgumentError, "Missing the required parameter 'note_id' when calling AssociationsApi.get_all"
            end
            # verify the required parameter 'to_object_type' is set
            if @api_client.config.client_side_validation && to_object_type.nil?
            ...
            # resource path
            local_var_path = '/crm/v3/objects/notes/{noteId}/associations/{toObjectType}'.sub('{' + 'noteId' + '}', CGI.escape(note_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
