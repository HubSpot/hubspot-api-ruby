      ...
      module Notes
        class AssociationsApi
          ...
          def get_all_with_http_info(note_id, to_object_type, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v4/objects/notes/{noteId}/associations/{toObjectType}'.sub('{' + 'noteId' + '}', CGI.escape(note_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
