    ...
    module Objects
      module Leads
        class BasicApi
          ...
          # @return [nil]
          def archive(leads_id, opts = {})
            archive_with_http_info(leads_id, opts)
            nil
          end
          ...
          def archive_with_http_info(leads_id, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.archive ...'
            end
            # verify the required parameter 'leads_id' is set
            if @api_client.config.client_side_validation && leads_id.nil?
              fail ArgumentError, "Missing the required parameter 'leads_id' when calling BasicApi.archive"
            end
            # resource path
            local_var_path = '/crm/v3/objects/leads/{leadsId}'.sub('{' + 'leadsId' + '}', CGI.escape(leads_id.to_s))
          ...
          def create_with_http_info(simple_public_object_input_for_create, opts = {})
            ...
            # resource path
            local_var_path = '/crm/v3/objects/leads'
          ...
          def get_by_id(leads_id, opts = {})
            data, _status_code, _headers = get_by_id_with_http_info(leads_id, opts)
            data
          end
          ...
          def get_by_id_with_http_info(leads_id, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.get_by_id ...'
            end
            # verify the required parameter 'leads_id' is set
            if @api_client.config.client_side_validation && leads_id.nil?
              fail ArgumentError, "Missing the required parameter 'leads_id' when calling BasicApi.get_by_id"
            end
            # resource path
            local_var_path = '/crm/v3/objects/leads/{leadsId}'.sub('{' + 'leadsId' + '}', CGI.escape(leads_id.to_s))
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object
          # @return [SimplePublicObject]
          def update(leads_id, simple_public_object_input, opts = {})
            data, _status_code, _headers = update_with_http_info(leads_id, simple_public_object_input, opts)
            data
          end
          ...
          # @option opts [String] :id_property The name of a property whose values are unique for this object
          # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
          def update_with_http_info(leads_id, simple_public_object_input, opts = {})
            if @api_client.config.debugging
              @api_client.config.logger.debug 'Calling API: BasicApi.update ...'
            end
            # verify the required parameter 'leads_id' is set
            if @api_client.config.client_side_validation && leads_id.nil?
              fail ArgumentError, "Missing the required parameter 'leads_id' when calling BasicApi.update"
            end
