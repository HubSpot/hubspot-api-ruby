  ...
  module Crm
    module Lists
      class PublicObjectList
        ...
        def hash
          [processing_type, object_type_id, updated_by_id, filters_updated_at, list_id, created_at, processing_status, deleted_at, list_version, name, created_by_id, filter_branch, updated_at].hash
        end
