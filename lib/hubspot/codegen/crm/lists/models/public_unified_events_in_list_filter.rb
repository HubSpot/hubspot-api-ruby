...
module Hubspot
  module Crm
    module Lists
      class PublicUnifiedEventsInListFilter
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Lists::PublicUnifiedEventsInListFilter` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Lists::PublicUnifiedEventsInListFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'filter_type')
            ...
            self.filter_type = 'UNIFIED_EVENTS_IN_LIST'
          end
        ...
        def valid?
          ...
          filter_type_validator = EnumAttributeValidator.new('String', ["UNIFIED_EVENTS_IN_LIST"])
        ...
        def filter_type=(filter_type)
          validator = EnumAttributeValidator.new('String', ["UNIFIED_EVENTS_IN_LIST"])
        ...
        def hash
          [filter_type, pruning_refine_by, coalescing_refine_by, list_id, event_type_id].hash
        end
