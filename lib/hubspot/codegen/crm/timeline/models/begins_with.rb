      ...
      class BeginsWith
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Timeline::BeginsWith` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Timeline::BeginsWith`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'string_to_check')
            self.string_to_check = attributes[:'string_to_check']
          end
        ...
        def list_invalid_properties
          ...
          if @string_to_check.nil?
            invalid_properties.push('invalid value for "string_to_check", string_to_check cannot be nil.')
          end
        ...
        def valid?
          ...
          operator_validator = EnumAttributeValidator.new('String', ["BEGINS_WITH"])
        ...
        def operator=(operator)
          validator = EnumAttributeValidator.new('String', ["BEGINS_WITH"])
        ...
        def ==(o)
          ...
          self.class == o.class &&
              ...
              value == o.value &&
              inputs == o.inputs &&
              string_to_check == o.string_to_check &&
        ...
        def hash
          [operator, value, inputs, string_to_check, property_name].hash
        end
