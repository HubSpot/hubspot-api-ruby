      ...
      class IsPresent
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Timeline::IsPresent` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Timeline::IsPresent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'expression_to_evaluate')
            self.expression_to_evaluate = attributes[:'expression_to_evaluate']
          end
        ...
        def list_invalid_properties
          ...
          if @expression_to_evaluate.nil?
            invalid_properties.push('invalid value for "expression_to_evaluate", expression_to_evaluate cannot be nil.')
          end
        ...
        def valid?
          ...
          operator_validator = EnumAttributeValidator.new('String', ["IS_PRESENT"])
          return false unless operator_validator.valid?(@operator)
          return false if @expression_to_evaluate.nil?
          true
        end
        ...
        def operator=(operator)
          validator = EnumAttributeValidator.new('String', ["IS_PRESENT"])
        ...
        def ==(o)
          ...
          self.class == o.class &&
              ...
              value == o.value &&
              inputs == o.inputs &&
              expression_to_evaluate == o.expression_to_evaluate &&
        ...
        def hash
          [operator, value, inputs, expression_to_evaluate, property_name].hash
        end
