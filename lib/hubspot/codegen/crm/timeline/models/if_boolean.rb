      ...
      class IfBoolean
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Timeline::IfBoolean` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Timeline::IfBoolean`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'if_expression')
            self.if_expression = attributes[:'if_expression']
          end

          if attributes.key?(:'else_expression')
            self.else_expression = attributes[:'else_expression']
          end
        ...
        def list_invalid_properties
          ...
          if @if_expression.nil?
            invalid_properties.push('invalid value for "if_expression", if_expression cannot be nil.')
          end
        ...
        def valid?
          ...
          operator_validator = EnumAttributeValidator.new('String', ["IF_BOOLEAN"])
          return false unless operator_validator.valid?(@operator)
          return false if @if_expression.nil?
          true
        end
        ...
        def operator=(operator)
          validator = EnumAttributeValidator.new('String', ["IF_BOOLEAN"])
        ...
        def ==(o)
          ...
          self.class == o.class &&
              ...
              value == o.value &&
              inputs == o.inputs &&
              if_expression == o.if_expression &&
              else_expression == o.else_expression &&
        ...
        def hash
          [operator, value, inputs, if_expression, else_expression, property_name].hash
        end
