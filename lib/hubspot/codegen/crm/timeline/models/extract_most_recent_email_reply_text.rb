      ...
      class ExtractMostRecentEmailReplyText
        ...
        def initialize(attributes = {})
          if (!attributes.is_a?(Hash))
            fail ArgumentError, "The input argument (attributes) must be a hash in `Hubspot::Crm::Timeline::ExtractMostRecentEmailReplyText` initialize method"
          end

          # check to see if the attribute exists and convert string to symbol for hash key
          attributes = attributes.each_with_object({}) { |(k, v), h|
            if (!self.class.attribute_map.key?(k.to_sym))
              fail ArgumentError, "`#{k}` is not a valid attribute in `Hubspot::Crm::Timeline::ExtractMostRecentEmailReplyText`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
            end
            h[k.to_sym] = v
          }
          ...
          if attributes.key?(:'operator')
            ...
            self.operator = 'EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT'
          end
        ...
        def valid?
          ...
          operator_validator = EnumAttributeValidator.new('String', ["EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT"])
        ...
        def operator=(operator)
          validator = EnumAttributeValidator.new('String', ["EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT"])
