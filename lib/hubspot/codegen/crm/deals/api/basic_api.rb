    ...
    module Deals
      class BasicApi
        ...
        def archive_with_http_info(deal_id, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/objects/deals/{dealId}'.sub('{' + 'dealId' + '}', CGI.escape(deal_id.to_s).gsub('%2F', '/'))
        ...
        # @option opts [SimplePublicObjectInput] :simple_public_object_input 
        # @return [SimplePublicObject]
        def update(deal_id, opts = {})
          data, _status_code, _headers = update_with_http_info(deal_id, opts)
          data
        end
        ...
        # @option opts [SimplePublicObjectInput] :simple_public_object_input 
        # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
        def update_with_http_info(deal_id, opts = {})
          if @api_client.config.debugging
