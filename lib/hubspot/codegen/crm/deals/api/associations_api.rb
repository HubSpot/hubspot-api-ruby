    ...
    module Deals
      class AssociationsApi
        ...
        def archive_with_http_info(deal_id, to_object_type, to_object_id, association_type, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v4/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId}'.sub('{' + 'dealId' + '}', CGI.escape(deal_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
