  ...
  module Crm
    module Tickets
      class AssociationsApi
        ...
        # @return [nil]
        def archive_association(ticket_id, to_object_type, to_object_id, association_type, opts = {})
          archive_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, opts)
          nil
        end
        ...
        def archive_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, opts = {})
          ...
          if @api_client.config.client_side_validation && ticket_id.nil?
            fail ArgumentError, "Missing the required parameter 'ticket_id' when calling AssociationsApi.archive_association"
          end
          ...
          # resource path
          local_var_path = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}'.sub('{' + 'ticketId' + '}', CGI.escape(ticket_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s)).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s)).sub('{' + 'associationType' + '}', CGI.escape(association_type.to_s))
        ...
        def create_association(ticket_id, to_object_type, to_object_id, association_type, opts = {})
          data, _status_code, _headers = create_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, opts)
          data
        end
        ...
        def create_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.create_association ...'
          end
          # verify the required parameter 'ticket_id' is set
          if @api_client.config.client_side_validation && ticket_id.nil?
            fail ArgumentError, "Missing the required parameter 'ticket_id' when calling AssociationsApi.create_association"
          end
          # verify the required parameter 'to_object_type' is set
          if @api_client.config.client_side_validation && to_object_type.nil?
        ...
        def get_associations(ticket_id, to_object_type, opts = {})
          data, _status_code, _headers = get_associations_with_http_info(ticket_id, to_object_type, opts)
          data
        end
        ...
        def get_associations_with_http_info(ticket_id, to_object_type, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: AssociationsApi.get_associations ...'
          end
          # verify the required parameter 'ticket_id' is set
          if @api_client.config.client_side_validation && ticket_id.nil?
            fail ArgumentError, "Missing the required parameter 'ticket_id' when calling AssociationsApi.get_associations"
          end
          # verify the required parameter 'to_object_type' is set
          if @api_client.config.client_side_validation && to_object_type.nil?
          ...
          # resource path
          local_var_path = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}'.sub('{' + 'ticketId' + '}', CGI.escape(ticket_id.to_s)).sub('{' + 'toObjectType' + '}', CGI.escape(to_object_type.to_s))
