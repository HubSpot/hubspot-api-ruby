  ...
  module Crm
    module Tickets
      class AssociationsApi
        ...
        # @return [nil]
        def archive_association(ticket_id, associated_object_type, to_object_id, opts = {})
          archive_association_with_http_info(ticket_id, associated_object_type, to_object_id, opts)
          nil
        end
        ...
        def archive_association_with_http_info(ticket_id, associated_object_type, to_object_id, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/objects/tickets/{ticketId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'ticketId' + '}', CGI.escape(ticket_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/')).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s).gsub('%2F', '/'))
        ...
        def create_association(ticket_id, associated_object_type, to_object_id, opts = {})
          data, _status_code, _headers = create_association_with_http_info(ticket_id, associated_object_type, to_object_id, opts)
          data
        end
        ...
        def create_association_with_http_info(ticket_id, associated_object_type, to_object_id, opts = {})
          if @api_client.config.debugging
        ...
        def get_associations(ticket_id, associated_object_type, opts = {})
          data, _status_code, _headers = get_associations_with_http_info(ticket_id, associated_object_type, opts)
          data
        end
        ...
        def get_associations_with_http_info(ticket_id, associated_object_type, opts = {})
          if @api_client.config.debugging
          ...
          # resource path
          local_var_path = '/crm/v3/objects/tickets/{ticketId}/associations/{associatedObjectType}'.sub('{' + 'ticketId' + '}', CGI.escape(ticket_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/'))
