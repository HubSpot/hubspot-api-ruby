    ...
    module Properties
      class GroupsApi
        ...
        def archive_with_http_info(object_type, group_name, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/properties/{objectType}/groups/{groupName}'.sub('{' + 'objectType' + '}', CGI.escape(object_type.to_s).gsub('%2F', '/')).sub('{' + 'groupName' + '}', CGI.escape(group_name.to_s).gsub('%2F', '/'))
        ...
        def create_with_http_info(object_type, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/properties/{objectType}/groups'.sub('{' + 'objectType' + '}', CGI.escape(object_type.to_s).gsub('%2F', '/'))
