    ...
    module Products
      class BasicApi
        ...
        def archive(product_id, opts = {})
          archive_with_http_info(product_id, opts)
          nil
        end
        ...
        def archive_with_http_info(product_id, opts = {})
          ...
          if @api_client.config.client_side_validation && product_id.nil?
            fail ArgumentError, "Missing the required parameter 'product_id' when calling BasicApi.archive"
          end
          # resource path
          local_var_path = '/crm/v3/objects/products/{productId}'.sub('{' + 'productId' + '}', CGI.escape(product_id.to_s).gsub('%2F', '/'))
        ...
        # @return [SimplePublicObject]
        def get_by_id(product_id, opts = {})
          data, _status_code, _headers = get_by_id_with_http_info(product_id, opts)
          data
        end
        ...
        # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
        def get_by_id_with_http_info(product_id, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.get_by_id ...'
          end
          # verify the required parameter 'product_id' is set
          if @api_client.config.client_side_validation && product_id.nil?
            fail ArgumentError, "Missing the required parameter 'product_id' when calling BasicApi.get_by_id"
          end
          # resource path
          local_var_path = '/crm/v3/objects/products/{productId}'.sub('{' + 'productId' + '}', CGI.escape(product_id.to_s).gsub('%2F', '/'))
        ...
        # @option opts [SimplePublicObjectInput] :simple_public_object_input 
        # @return [SimplePublicObject]
        def update(product_id, opts = {})
          data, _status_code, _headers = update_with_http_info(product_id, opts)
          data
        end
        ...
        # @option opts [SimplePublicObjectInput] :simple_public_object_input 
        # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
        def update_with_http_info(product_id, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BasicApi.update ...'
          end
          # verify the required parameter 'product_id' is set
          if @api_client.config.client_side_validation && product_id.nil?
            fail ArgumentError, "Missing the required parameter 'product_id' when calling BasicApi.update"
          end
          # resource path
          local_var_path = '/crm/v3/objects/products/{productId}'.sub('{' + 'productId' + '}', CGI.escape(product_id.to_s).gsub('%2F', '/'))
