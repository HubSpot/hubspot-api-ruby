    ...
    module Products
      class AssociationsApi
        ...
        def archive_association_with_http_info(product_id, associated_object_type, to_object_id, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/objects/products/{productId}/associations/{associatedObjectType}/{toObjectId}'.sub('{' + 'productId' + '}', CGI.escape(product_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/')).sub('{' + 'toObjectId' + '}', CGI.escape(to_object_id.to_s).gsub('%2F', '/'))
        ...
        def get_associations_with_http_info(product_id, associated_object_type, opts = {})
          ...
          # resource path
          local_var_path = '/crm/v3/objects/products/{productId}/associations/{associatedObjectType}'.sub('{' + 'productId' + '}', CGI.escape(product_id.to_s).gsub('%2F', '/')).sub('{' + 'associatedObjectType' + '}', CGI.escape(associated_object_type.to_s).gsub('%2F', '/'))
