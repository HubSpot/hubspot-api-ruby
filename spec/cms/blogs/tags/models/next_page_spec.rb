...
# Unit tests for Hubspot::Cms::Blogs::Tags::NextPage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NextPage' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Blogs::Tags::NextPage.new
  end
  ...
  describe 'test an instance of NextPage' do
    it 'should create an instance of NextPage' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Blogs::Tags::NextPage)
    end
  end
