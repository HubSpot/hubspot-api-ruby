...
# Unit tests for Hubspot::Cms::Hubdb::ImportResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImportResult' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Hubdb::ImportResult.new
  end
  ...
  describe 'test an instance of ImportResult' do
    it 'should create an instance of ImportResult' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Hubdb::ImportResult)
    end
  end
  ...
  describe 'test attribute "rows_imported"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "duplicate_rows"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "row_limit_exceeded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
