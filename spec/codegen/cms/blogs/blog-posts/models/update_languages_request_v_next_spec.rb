...
# Unit tests for Hubspot::Cms::Blogs::BlogPosts::UpdateLanguagesRequestVNext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateLanguagesRequestVNext' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Blogs::BlogPosts::UpdateLanguagesRequestVNext.new
  end
  ...
  describe 'test an instance of UpdateLanguagesRequestVNext' do
    it 'should create an instance of UpdateLanguagesRequestVNext' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Blogs::BlogPosts::UpdateLanguagesRequestVNext)
    end
  end
