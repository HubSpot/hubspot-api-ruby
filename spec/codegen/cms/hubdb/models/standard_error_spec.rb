...
# Unit tests for Hubspot::Cms::Hubdb::StandardError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StandardError' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Hubdb::StandardError.new
  end
  ...
  describe 'test an instance of StandardError' do
    it 'should create an instance of StandardError' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Hubdb::StandardError)
    end
  end
