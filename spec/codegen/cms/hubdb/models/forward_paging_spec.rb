...
# Unit tests for Hubspot::Cms::Hubdb::ForwardPaging
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ForwardPaging' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Hubdb::ForwardPaging.new
  end
  ...
  describe 'test an instance of ForwardPaging' do
    it 'should create an instance of ForwardPaging' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Hubdb::ForwardPaging)
    end
  end
