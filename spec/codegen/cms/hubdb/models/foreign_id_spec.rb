...
# Unit tests for Hubspot::Cms::Hubdb::ForeignId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ForeignId' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Hubdb::ForeignId.new
  end
  ...
  describe 'test an instance of ForeignId' do
    it 'should create an instance of ForeignId' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Hubdb::ForeignId)
    end
  end
