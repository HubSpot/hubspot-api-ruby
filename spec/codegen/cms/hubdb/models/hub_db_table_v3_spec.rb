...
# Unit tests for Hubspot::Cms::Hubdb::HubDbTableV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HubDbTableV3' do
  before do
    # run before each test
    @instance = Hubspot::Cms::Hubdb::HubDbTableV3.new
  end
  ...
  describe 'test an instance of HubDbTableV3' do
    it 'should create an instance of HubDbTableV3' do
      expect(@instance).to be_instance_of(Hubspot::Cms::Hubdb::HubDbTableV3)
    end
  end
  ...
  describe 'test attribute "use_for_pages"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "enable_child_table_pages"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
