...
# Unit tests for Hubspot::Crm::Extensions::Calling::SettingsPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SettingsPatchRequest' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Extensions::Calling::SettingsPatchRequest.new
  end
  ...
  describe 'test an instance of SettingsPatchRequest' do
    it 'should create an instance of SettingsPatchRequest' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Extensions::Calling::SettingsPatchRequest)
    end
  end
