...
# Unit tests for Hubspot::Crm::Extensions::Calling::SettingsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SettingsResponse' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Extensions::Calling::SettingsResponse.new
  end
  ...
  describe 'test an instance of SettingsResponse' do
    it 'should create an instance of SettingsResponse' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Extensions::Calling::SettingsResponse)
    end
  end
