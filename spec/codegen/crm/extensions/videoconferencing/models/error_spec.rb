...
# Unit tests for Hubspot::Crm::Extensions::Videoconferencing::Error
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Error' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Extensions::Videoconferencing::Error.new
  end
  ...
  describe 'test an instance of Error' do
    it 'should create an instance of Error' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Extensions::Videoconferencing::Error)
    end
  end
