...
# Unit tests for Hubspot::Crm::Imports::ActionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ActionResponse' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Imports::ActionResponse.new
  end
  ...
  describe 'test an instance of ActionResponse' do
    it 'should create an instance of ActionResponse' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Imports::ActionResponse)
    end
  end
