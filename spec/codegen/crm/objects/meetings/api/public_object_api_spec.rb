...
# Unit tests for Hubspot::Crm::Objects::Meetings::PublicObjectApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PublicObjectApi' do
  before do
    # run before each test
    @api_instance = Hubspot::Crm::Objects::Meetings::PublicObjectApi.new
  end
  ...
  describe 'test an instance of PublicObjectApi' do
    it 'should create an instance of PublicObjectApi' do
      expect(@api_instance).to be_instance_of(Hubspot::Crm::Objects::Meetings::PublicObjectApi)
    end
  end
