...
# Unit tests for Hubspot::Crm::Objects::ErrorCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorCategory' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Objects::ErrorCategory.new
  end
  ...
  describe 'test an instance of ErrorCategory' do
    it 'should create an instance of ErrorCategory' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Objects::ErrorCategory)
    end
  end
