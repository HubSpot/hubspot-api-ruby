...
# Unit tests for Hubspot::Crm::Objects::Tasks::BasicApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BasicApi' do
  before do
    # run before each test
    @api_instance = Hubspot::Crm::Objects::Tasks::BasicApi.new
  end
  ...
  describe 'test an instance of BasicApi' do
    it 'should create an instance of BasicApi' do
      expect(@api_instance).to be_instance_of(Hubspot::Crm::Objects::Tasks::BasicApi)
    end
  end
