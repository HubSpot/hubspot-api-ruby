...
# Unit tests for Hubspot::Crm::Objects::Tasks::Filter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Filter' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Objects::Tasks::Filter.new
  end
  ...
  describe 'test an instance of Filter' do
    it 'should create an instance of Filter' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Objects::Tasks::Filter)
    end
  end
