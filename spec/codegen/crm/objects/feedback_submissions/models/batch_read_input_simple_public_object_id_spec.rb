...
# Unit tests for Hubspot::Crm::Objects::FeedbackSubmissions::BatchReadInputSimplePublicObjectId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BatchReadInputSimplePublicObjectId' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Objects::FeedbackSubmissions::BatchReadInputSimplePublicObjectId.new
  end
  ...
  describe 'test an instance of BatchReadInputSimplePublicObjectId' do
    it 'should create an instance of BatchReadInputSimplePublicObjectId' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Objects::FeedbackSubmissions::BatchReadInputSimplePublicObjectId)
    end
  end
