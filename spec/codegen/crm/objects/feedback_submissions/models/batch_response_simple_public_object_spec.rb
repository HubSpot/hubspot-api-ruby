...
# Unit tests for Hubspot::Crm::Objects::FeedbackSubmissions::BatchResponseSimplePublicObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BatchResponseSimplePublicObject' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Objects::FeedbackSubmissions::BatchResponseSimplePublicObject.new
  end
  ...
  describe 'test an instance of BatchResponseSimplePublicObject' do
    it 'should create an instance of BatchResponseSimplePublicObject' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Objects::FeedbackSubmissions::BatchResponseSimplePublicObject)
    end
  end
