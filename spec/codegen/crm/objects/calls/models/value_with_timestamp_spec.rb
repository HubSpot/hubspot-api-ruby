...
# Unit tests for Hubspot::Crm::Objects::Calls::ValueWithTimestamp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ValueWithTimestamp' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Objects::Calls::ValueWithTimestamp.new
  end
  ...
  describe 'test an instance of ValueWithTimestamp' do
    it 'should create an instance of ValueWithTimestamp' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Objects::Calls::ValueWithTimestamp)
    end
  end
