...
# Unit tests for Hubspot::Settings::Users::ErrorDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorDetail' do
  before do
    # run before each test
    @instance = Hubspot::Settings::Users::ErrorDetail.new
  end
  ...
  describe 'test an instance of ErrorDetail' do
    it 'should create an instance of ErrorDetail' do
      expect(@instance).to be_instance_of(Hubspot::Settings::Users::ErrorDetail)
    end
  end
