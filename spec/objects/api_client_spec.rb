...
describe Hubspot::Client::Crm::Objects::ApiClient do
    ...
    context 'URL stuff' do
      ...
      context 'base_path' do
        it "prepends a slash to base_path" do
          Hubspot::Objects.configure { |c| c.base_path = 'v4/dog' }
        ...
        it "ends up as a blank string if nil" do
          Hubspot::Objects.configure { |c| c.base_path = nil }
  ...
  describe "#object_to_hash" do
    it 'ignores nils and includes empty arrays' do
      ...
      # api_client = Hubspot::Client::Crm::Objects::ApiClient.new
      # _model = Hubspot::Client::Crm::Objects::ModelName.new
