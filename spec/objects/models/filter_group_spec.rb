...
# Unit tests for Hubspot::Client::Crm::Objects::Models::FilterGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FilterGroup' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Objects::Models::FilterGroup.new
  end
  ...
  describe 'test an instance of FilterGroup' do
    it 'should create an instance of FilterGroup' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Objects::Models::FilterGroup)
    end
  end
