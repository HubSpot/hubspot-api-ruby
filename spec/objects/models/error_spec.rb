...
# Unit tests for Hubspot::Client::Crm::Objects::Models::Error
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Error' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Objects::Models::Error.new
  end
  ...
  describe 'test an instance of Error' do
    it 'should create an instance of Error' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Objects::Models::Error)
    end
  end
