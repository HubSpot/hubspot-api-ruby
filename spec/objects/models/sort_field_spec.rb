...
# Unit tests for Hubspot::Client::Crm::Objects::Models::SortField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SortField' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Objects::Models::SortField.new
  end
  ...
  describe 'test an instance of SortField' do
    it 'should create an instance of SortField' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Objects::Models::SortField)
    end
  end
