...
# Unit tests for Hubspot::Client::Crm::Objects::Models::BatchReadInputSimplePublicObjectId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchReadInputSimplePublicObjectId' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Objects::Models::BatchReadInputSimplePublicObjectId.new
  end
  ...
  describe 'test an instance of BatchReadInputSimplePublicObjectId' do
    it 'should create an instance of BatchReadInputSimplePublicObjectId' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Objects::Models::BatchReadInputSimplePublicObjectId)
    end
  end
