...
# Unit tests for Hubspot::Client::Crm::Owners::Models::NextPage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NextPage' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Owners::Models::NextPage.new
  end
  ...
  describe 'test an instance of NextPage' do
    it 'should create an instance of NextPage' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Owners::Models::NextPage)
    end
  end
