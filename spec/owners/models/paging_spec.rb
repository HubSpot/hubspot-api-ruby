...
# Unit tests for Hubspot::Client::Crm::Owners::Models::Paging
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Paging' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Owners::Models::Paging.new
  end
  ...
  describe 'test an instance of Paging' do
    it 'should create an instance of Paging' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Owners::Models::Paging)
    end
  end
