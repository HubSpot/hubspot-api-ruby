...
describe Hubspot::Client::Crm::Owners::ApiClient do
  ...
  describe 'params_encoding in #build_request' do
    let(:config) { Hubspot::Client::Crm::Owners::Configuration.new }
    let(:api_client) { Hubspot::Client::Crm::Owners::ApiClient.new(config) }

    it 'defaults to nil' do
      expect(Hubspot::Client::Crm::Owners::Configuration.default.params_encoding).to eq(nil)
  ...
  describe 'timeout in #build_request' do
    ...
    it 'defaults to 0' do
      expect(Hubspot::Client::Crm::Owners::Configuration.default.timeout).to eq(0)
  ...
  describe '#deserialize' do
    it "handles Array<Integer>" do
      api_client = Hubspot::Client::Crm::Owners::ApiClient.new
  ...
  describe "#object_to_hash" do
    it 'ignores nils and includes empty arrays' do
      ...
      # api_client = Hubspot::Client::Crm::Owners::ApiClient.new
      # _model = Hubspot::Client::Crm::Owners::Models::ModelName.new
  ...
  describe '#build_collection_param' do
    let(:param) { ['aa', 'bb', 'cc'] }
    let(:api_client) { Hubspot::Client::Crm::Owners::ApiClient.new }
