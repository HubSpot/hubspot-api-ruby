...
# Unit tests for Hubspot::Client::Crm::Pipelines::Models::Pipeline
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Pipeline' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Pipelines::Models::Pipeline.new
  end
  ...
  describe 'test an instance of Pipeline' do
    it 'should create an instance of Pipeline' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Pipelines::Models::Pipeline)
    end
  end
