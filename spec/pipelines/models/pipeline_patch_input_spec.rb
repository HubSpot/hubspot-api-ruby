...
# Unit tests for Hubspot::Crm::Pipelines::PipelinePatchInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PipelinePatchInput' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Pipelines::PipelinePatchInput.new
  end
  ...
  describe 'test an instance of PipelinePatchInput' do
    it 'should create an instance of PipelinePatchInput' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Pipelines::PipelinePatchInput)
    end
  end
