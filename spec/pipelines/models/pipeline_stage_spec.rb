...
# Unit tests for Hubspot::Client::Crm::Pipelines::Models::PipelineStage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PipelineStage' do
  before do
    # run before each test
    @instance = Hubspot::Client::Crm::Pipelines::Models::PipelineStage.new
  end
  ...
  describe 'test an instance of PipelineStage' do
    it 'should create an instance of PipelineStage' do
      expect(@instance).to be_instance_of(Hubspot::Client::Crm::Pipelines::Models::PipelineStage)
    end
  end
