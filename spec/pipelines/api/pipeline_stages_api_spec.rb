...
describe 'PipelineStagesApi' do
  before do
    ...
    @api_instance = Hubspot::Client::Crm::Pipelines::Api::PipelineStagesApi.new
  end
  ...
  describe 'test an instance of PipelineStagesApi' do
    it 'should create an instance of PipelineStagesApi' do
      expect(@api_instance).to be_instance_of(Hubspot::Client::Crm::Pipelines::Api::PipelineStagesApi)
    end
  end
