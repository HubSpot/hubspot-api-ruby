...
# Unit tests for Hubspot::Webhooks::SubscriptionCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SubscriptionCreateRequest' do
  before do
    # run before each test
    @instance = Hubspot::Webhooks::SubscriptionCreateRequest.new
  end
  ...
  describe 'test an instance of SubscriptionCreateRequest' do
    it 'should create an instance of SubscriptionCreateRequest' do
      expect(@instance).to be_instance_of(Hubspot::Webhooks::SubscriptionCreateRequest)
    end
  end
