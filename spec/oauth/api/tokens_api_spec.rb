...
# Unit tests for Hubspot::Client::OAuth::Api::TokensApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TokensApi' do
  before do
    # run before each test
    @instance = Hubspot::Client::OAuth::Api::TokensApi.new
  end
  ...
  describe 'test an instance of TokensApi' do
    it 'should create an instance of TokensApi' do
      expect(@instance).to be_instance_of(Hubspot::Client::OAuth::Api::TokensApi)
    end
  end
