...
# Unit tests for Hubspot::Client::OAuth::Api::RefreshTokensApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RefreshTokensApi' do
  before do
    # run before each test
    @instance = Hubspot::Client::OAuth::Api::RefreshTokensApi.new
  end
  ...
  describe 'test an instance of RefreshTokensApi' do
    it 'should create an instance of RefreshTokensApi' do
      expect(@instance).to be_instance_of(Hubspot::Client::OAuth::Api::RefreshTokensApi)
    end
  end
