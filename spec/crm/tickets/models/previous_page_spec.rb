...
# Unit tests for Hubspot::Crm::Tickets::PreviousPage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PreviousPage' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Tickets::PreviousPage.new
  end
  ...
  describe 'test an instance of PreviousPage' do
    it 'should create an instance of PreviousPage' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Tickets::PreviousPage)
    end
  end
