...
# Unit tests for Hubspot::Crm::Properties::ErrorDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ErrorDetail' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Properties::ErrorDetail.new
  end
  ...
  describe 'test an instance of ErrorDetail' do
    it 'should create an instance of ErrorDetail' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Properties::ErrorDetail)
    end
  end
