...
# Unit tests for Hubspot::Crm::Properties::PropertyCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyCreate' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Properties::PropertyCreate.new
  end
  ...
  describe 'test an instance of PropertyCreate' do
    it 'should create an instance of PropertyCreate' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Properties::PropertyCreate)
    end
  end
