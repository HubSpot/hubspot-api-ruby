...
# Unit tests for Hubspot::Crm::Properties::PropertyGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyGroup' do
  before do
    # run before each test
    @instance = Hubspot::Crm::Properties::PropertyGroup.new
  end
  ...
  describe 'test an instance of PropertyGroup' do
    it 'should create an instance of PropertyGroup' do
      expect(@instance).to be_instance_of(Hubspot::Crm::Properties::PropertyGroup)
    end
  end
